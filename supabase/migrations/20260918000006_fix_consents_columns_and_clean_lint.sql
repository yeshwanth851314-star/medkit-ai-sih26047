-- =============================================================================
-- Migration: 20260918000006_fix_consents_columns_and_clean_lint.sql
-- Description:
--   Phase C & Phase D V1 True Final Closure (Forward-only):
--   1. Correct public.consents column mapping inside rpc_execute_idempotent_mutation.
--   2. Reference p_payload_hash to achieve clean linter conformance.
-- =============================================================================
