  ...
  return (
    <span className={`inline-flex items-center relative ${className}`}>
      <button
        ...
        className="inline-flex h-4 w-4 items-center justify-center rounded-full text-slate-400 hover:text-clinical-700 hover:bg-clinical-50 transition-colors focus:outline-hidden focus:ring-2 focus:ring-clinical-500"
      >
      ...
      {isOpen && (
        <div
          ...
          className="absolute z-50 w-72 sm:w-80 rounded-xl border border-surface-200 bg-white p-4 shadow-xl text-left text-xs text-slate-700 space-y-2.5 animate-in fade-in duration-150 top-full mt-2 left-1/2 -translate-x-1/2 sm:left-0 sm:translate-x-0"
        >
