      ...
      {c.red_flags && c.red_flags.length > 0 && (
        <div className="rounded-xl border border-red-200 bg-red-50 p-4 text-red-900 space-y-2" role="alert">
          <div className="flex items-center gap-2 font-bold text-sm text-red-700">
            ...
            POTENTIAL RED FLAG SIGNAL
          </div>
          <p className="text-xs">{c.red_flags[0].message}</p>
          <div className="text-[11px] text-red-600 italic">
            Safety rule: Immediate clinical evaluation recommended. Non-diagnostic alert.
          </div>
        </div>
      )}
          ...
          <div className="rounded-xl border border-surface-200 bg-white p-6 shadow-xs">
            <div className="flex items-center justify-between border-b border-surface-200 pb-3 mb-4">
              ...
              <span className="rounded bg-slate-100 px-2 py-0.5 text-[10px] font-semibold text-slate-600">
                Source: {c.provenance?.hpi || "patient"}
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="rounded-xl border border-surface-200 bg-white p-5 shadow-xs">
            <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider mb-3 flex items-center gap-1.5">
              <Pill className="h-4 w-4 text-clinical-600" /> Medications
            </h3>
